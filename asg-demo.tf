provider "aws" {
region = "us-east-2"
access_key = "AKIAIH2DC3OMIOF45WIA"
  secret_key = "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"
}

resource "aws_launch_configuration" "test_lc" {
  name          = "web_config"
  image_id      = "ami-0cf31d971a3ca20d6"
  instance_type = "t2.micro"
  security_groups = ["sg-08b94a572ae5e8cc1"]
...
resource "aws_autoscaling_group" "asg_test" {
  ...
  min_size             = 1
  max_size             = 1
  vpc_zone_identifier  = ["subnet-d59a3eaf"]
  lifecycle {
